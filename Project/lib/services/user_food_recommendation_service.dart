    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (conflicts.isNotEmpty) {
          ...
          print('   Conflicting food IDs: $conflicts');
          print('   → Prioritizing AVOID for safety');
        }
        ...
        // Debug print
        print('🔴 UserFoodRecommendationService loaded:');
        print('   Foods to avoid: $_foodsToAvoid');
        print('   Foods to recommend: $_foodsToRecommend');
      } else {
        _isLoaded = false;
      }
    } catch (e) {
