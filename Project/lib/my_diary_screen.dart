...
class _MyDiaryScreenState extends State<MyDiaryScreen>
  ...
  void addAllListData() {
      ...
      TitleView(
        ...
        onTap: () async {
          ...
          final breakfast =
              ...
              : '25';
          final lunch = (settings != null && settings['meal_pct_lunch'] != null)
              ? settings['meal_pct_lunch'].toString()
              : '35';
          final snack = (settings != null && settings['meal_pct_snack'] != null)
          ...
          final result = await showDialog<bool>(
            ...
            builder: (ctx) {
              return AlertDialog(
                title: const Text('Customize meal distribution'),
                  ...
                  TextButton(
                    onPressed: () async {
                      ...
                      final payload = {
                        ...
                        'meal_pct_lunch': double.parse(l.toStringAsFixed(2)),
                        'meal_pct_snack': double.parse(s.toStringAsFixed(2)),
                        'meal_pct_dinner': double.parse(d.toStringAsFixed(2)),
                      ...
                      if (res == null || res['error'] != null) {
                        ScaffoldMessenger.of(ctx).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Failed to save: ${res != null ? res['error'] : 'Network'}',
                            ),
                          ),
                        );
                        return;
    ...
    // Vitamins section (top 10) — moved after Meals
    listViews.add(
      TitleView(
        titleTxt: 'Vitamins',
        subTxt: 'Details',
        ...
        animationController: widget.animationController!,
        onTap: () {
          // navigate to full vitamins page
          Navigator.of(context).push(
            MaterialPageRoute<void>(builder: (ctx) => const VitaminsScreen()),
          );
        },
      ),
    );
    ...
    // Amino acids section (top 6) — appears after Vitamins
    listViews.add(
      TitleView(
        titleTxt: 'Amino acids',
        subTxt: 'Details',
        animation: Tween<double>(begin: 0.0, end: 1.0).animate(
          CurvedAnimation(
            parent: widget.animationController!,
        ...
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute<void>(builder: (ctx) => const AminoScreen()),
          );
        },
      ),
    );
    ...
    // Minerals section (top 6) — appears after Vitamins
    listViews.add(
      TitleView(
        titleTxt: 'Minerals',
        subTxt: 'Details',
        ...
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute<void>(builder: (ctx) => const MineralsScreen()),
          );
        },
      ),
    );
    ...
    // Fiber card (Total Fiber) placed alongside Water
    listViews.add(
      TitleView(
        titleTxt: 'Dietary Fiber',
        subTxt: 'Details',
        animation: Tween<double>(begin: 0.0, end: 1.0).animate(
          CurvedAnimation(
            parent: widget.animationController!,
        ...
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute<void>(builder: (ctx) => const FibersScreen()),
          );
        },
      ),
    );
    ...
    listViews.add(
      TitleView(
        ...
        onTap: () {
          Navigator.of(
            context,
          ).push(MaterialPageRoute<void>(builder: (ctx) => const FatsScreen()));
        },
      ),
    );
    listViews.add(
        ...
        children: [
          ...
          Row(
            children: [
              const Expanded(
                flex: 2,
                child: Text('Time (UTC+7):', style: TextStyle(fontSize: 14)),
              ),
              Expanded(
                flex: 3,
                child: TextField(
