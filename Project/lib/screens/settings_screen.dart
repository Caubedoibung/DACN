...
class _SettingsScreenState extends State<SettingsScreen>
  ...
  Future<void> _save() async {
    ...
    if (resp == null || resp['error'] != null) {
      messenger.showSnackBar(
        SnackBar(content: Text(resp?['error']?.toString() ?? 'Lỗi khi lưu')),
      );
      return;
    }
  ...
  Future<void> _refreshWeather() async {
    ...
    if (resp == null || resp['error'] != null) {
      messenger.showSnackBar(
        SnackBar(
          content: Text(resp?['error']?.toString() ?? 'Lỗi khi lấy thời tiết'),
        ),
      );
      return;
    }
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildSectionCard(
                              ...
                              children: [
                                _buildModernSwitchTile(
                                  title: 'Cập nhật theo thời tiết',
                                  subtitle: 'Thay đổi giao diện theo thành phố',
                                  icon: Icons.cloud,
                                  color: Colors.lightBlue,
                                  value: _settings['weather_enabled'] == true,
                                  onChanged: (v) => setState(
                                ...
                                const SizedBox(height: 12),
                                _buildModernSwitchTile(
                                  title: 'Hiệu ứng theo thời tiết',
                                  subtitle: 'Mưa, tuyết, sương mù...',
                                ...
                                _buildModernTextField(
                                  ...
                                  color: Colors.lightBlue,
                                  enabled: _settings['weather_enabled'] == true,
                                ),
                                if (_settings['weather_last_data'] != null) ...[
                                  const SizedBox(height: 12),
                                  _buildWeatherInfo(),
                                ],
                              ],
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          _buildIntensityButton('Thấp', 0),
                                          _buildIntensityButton(
                                            'Trung bình',
                                            1,
                                          ),
                                          _buildIntensityButton('Cao', 2),
                                        ],
                                      ),
                                    ],
                                  ),
                            ...
                            _buildSectionCard(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 12),
                                _buildModernSwitchTile(
                                  title: 'Sử dụng ảnh nền tùy chỉnh',
                                  subtitle: 'Áp dụng URL ảnh nền bạn nhập',
                                  icon: Icons.image,
                                  color: Colors.pink,
                                  value: _bgEnabled,
                                  onChanged: (v) =>
  ...
  String _getWindDirection(int degrees) {
    ...
    if (degrees >= 292.5 && degrees < 337.5) return 'Tây Bắc (NW)';
    return 'N/A';
  }
            ...
            children: [
              ClipRRect(
                ...
                child: _previewPath == null
                    ...
                    : (_previewPath!.startsWith('http') ||
                              _previewPath!.startsWith('https')
                          ? CachedNetworkImage(
                              imageUrl: _previewPath!,
                              fit: BoxFit.cover,
                              width: double.infinity,
