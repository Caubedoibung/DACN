...
class _AdminUserActivityScreenState extends State<AdminUserActivityScreen>
  ...
  Widget _buildTimelineTab() {
    ...
    if (timeline.isEmpty) {
      return const Center(child: Text('Không có dữ liệu timeline'));
    }
                        ...
                        sideTitles: SideTitles(
                          ...
                          getTitlesWidget: (value, meta) {
                            if (value.toInt() >= 0 &&
                              ...
                              final date =
                                  DateTime.parse(bucket['time_bucket']);
                              return Padding(
                    ...
                    lineBarsData: [
                      LineChartBarData(
                        spots: timeline
                            ...
                            .entries
                            .map((e) {
                              final countRaw = e.value['count'] ?? 0;
                  ...
                  SizedBox(
                    ...
                    child: BarChart(
                      BarChartData(
                        ...
                        maxY: hourlyPattern.isEmpty
                            ...
                            : hourlyPattern
                                    .map((e) {
                                      ...
                                      return countRaw is int ? countRaw : int.tryParse(countRaw.toString()) ?? 0;
                                    })
                                    .reduce((a, b) => a > b ? a : b)
                                    .toDouble() *
                                1.2,
                        ...
                        borderData: FlBorderData(show: true),
                        barGroups: hourlyPattern
                            .map((item) {
                              final countRaw = item['count'] ?? 0;
                              final count = countRaw is int ? countRaw : int.tryParse(countRaw.toString()) ?? 0;
                              final hourRaw = item['hour'] ?? 0;
                              final hour = hourRaw is int ? hourRaw : int.tryParse(hourRaw.toString()) ?? 0;
  ...
  List<PieChartSectionData> _buildPieChartSections(
    ...
    final total = actionBreakdown.fold<int>(
        0, (sum, item) {
  ...
  Color _getActionColor(String action) {
    final colors = {
      ...
      'meal_updated': Colors.lightGreen,
      'meal_deleted': Colors.red,
  ...
  IconData _getActionIcon(String action) {
    final icons = {
      ...
      'meal_updated': Icons.edit,
      'meal_deleted': Icons.delete,
  ...
  String _getActionLabel(String action) {
    final labels = {
      ...
      'meal_updated': 'Cập nhật bữa ăn',
      'meal_deleted': 'Xóa bữa ăn',
